    ...
    <div class="col-md-12 col-lg-8 col-xl-9">
        <div class="card">
            ...
            <div class="card-body">
                <!-- <div class="email-media">
                    <div class="mt-0 d-sm-flex">
                        ...
                        <div class="media-body pt-0">
                            ...
                            <div class="media-title text-dark font-weight-semibold mt-1">Alica Nestle <span
                ...
                <div class="email-media">
                    <div class="mt-0 d-sm-flex">
                        ...
                        <div class="media-body pt-0">
                            <div class="float-right d-none d-md-flex fs-15">
                                <small
                                    class="mr-3 mt-1 text-muted"><?= date('M d, Y h:i A', strtotime($email['timestamp'])) ?></small>
                            </div>
                            <div class="media-title text-dark font-weight-semibold mt-1">
                                <?= esc($email['sender_name']) ?> <span class="text-muted font-weight-semibold">
                                    ( <?= esc($email['sender_email']) ?> )
                                </span>
                            </div>
                            <small class="mb-0">to <?= esc($email['receiver_name']) ?> <span
                                    class="text-muted font-weight-semibold">
                                    ( <?= esc($email['receiver_email']) ?> )
                                </span></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="eamil-body mt-5">
                    <h6>Subject: <?= esc($email['subject']) ?></h6>
                    <p><?= nl2br(esc($email['body'])) ?></p>
                </div>
            </div>
