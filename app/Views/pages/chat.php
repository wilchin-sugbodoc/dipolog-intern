                            ...
                            <ul class="list-group lg-alt chat-conatct-list" id="ChatList">
                                <li class="list-group-item media p-4 border-top mt-0">
                                    <div class="float-left pr-2">
                                        <img src="<?php echo base_url('public/assets/images/users/5.jpg'); ?>" alt=""
                                            class="avatar avatar-md brround">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Davil
                                            Parnell</div>
                                        <small class="list-group-item-text text-muted">Fierent fastidii recteque ad
                                            pro</small>
                                    </div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    <div class="float-left pr-2">
                                        <img src="<?php echo base_url('public/assets/images/users/2.jpg'); ?>" alt=""
                                            class="avatar avatar-md brround">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Ann
                                            Watkinson</div>
                                        <small class="list-group-item-text text-muted">Cum sociis natoque penatibus
                                        </small>
                                    </div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    <div class="float-left pr-2">
                                        <img src="<?php echo base_url('public/assets/images/users/7.jpg'); ?>" alt=""
                                            class="avatar avatar-md brround">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Marse
                                            Walter</div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    <div class="lv-avatar float-left pr-2">
                                        <img src="<?php echo base_url('public/assets/images/users/3.jpg'); ?>" alt=""
                                            class="avatar avatar-md brround">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Jeremy
                                            Robbins</div>
                                        <small class="list-group-item-text text-muted">Phasellus porttitor tellus
                                            nec</small>
                                    </div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    <div class="lv-avatar float-left pr-2">
                                        <img src="<?php echo base_url('public/assets/images/users/9.jpg'); ?>" alt=""
                                            class="avatar avatar-md brround">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Reginald
                                            Horace</div>
                                        <small class="list-group-item-text text-muted">Quisque consequat arcu
                                            eget</small>
                                    </div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    <div class="float-left pr-2">
                                        <img src="<?php echo base_url('public/assets/images/users/6.jpg'); ?>" alt=""
                                            class="avatar avatar-md brround">
                                    </div>
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Shark
                                            Henry</div>
                                        <small class="list-group-item-text text-muted">Nam lobortis odio et leo
                                            maximu</small>
                                    </div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">Paul Van
                                            Dack</div>
                                        <small class="list-group-item-text text-muted">Nam posuere purus sed velit
                                            auctor sodales</small>
                                    </div>
                                ...
                                <li class="list-group-item media p-4 border-top mt-0">
                                    ...
                                    <div class="media-body">
                                        <div class="list-group-item-heading text-default font-weight-semibold">James
                                            Anderson</div>
                ...
                <div class="ms-body">
                    <div class="action-header clearfix">
                        ...
                        <div class="float-left hidden-xs d-flex ml-6 chat-user">
                            <img src="<?php echo base_url('public/assets/images/users/16.jpg'); ?>" alt=""
                                class="avatar avatar-md brround mr-2">
                        ...
                        <ul class="ah-actions actions align-items-center">
                            ...
                            <li>
                                <a data-toggle="tooltip" href="" title="Archive"><svg class="svg-icon"
                                        xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                            ...
                            <li>
                                <a data-toggle="tooltip" href="" title="Trash"><svg class="svg-icon"
                                        xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                            ...
                            <li>
                                <a data-toggle="tooltip" href="" title="View Info"><svg class="svg-icon"
                                        xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                                        <path
                    ...
                    <div class="chat-body-style" id="ChatBody">
                        <div class="message-feed media mt-0">
                            ...
                            <div class="media-body">
                                <div class="mf-content">
                                    Quisque consequat arcu eget odio cursus, ut tempor arcu vestibulum. Etiam ex arcu,
                                    porta a urna non, lacinia pellentesque orci. Proin semper sagittis erat, eget
                        ...
                        <div class="message-feed right">
                            ...
                            <div class="media-body">
                                <div class="mf-content">
                                    Mauris volutpat magna nibh, et condimentum est rutrum a. Nunc sed turpis mi. In eu
                                    massa a sem pulvinar lobortis.
                                </div>
                        ...
                        <div class="message-feed right">
                            ...
                            <div class="media-body">
                                <div class="mf-content">
                                    Etiam nec facilisis lacus. Nulla imperdiet augue ullamcorper dui ullamcorper, eu
                        ...
                        <div class="message-feed media">
                            ...
                            <div class="media-body">
                                <div class="mf-content">
                                    ...
                                    mus. Etiam ac tortor ut elit sodales varius. Mauris id ipsum id mauris malesuada
                                    tincidunt. Vestibulum elit massa, pulvinar at sapien sed, luctus vestibulum eros.
                                </div>
                    ...
                    <div class="msb-reply">
                        ...
                        <button onclick="not7()"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 0 24 24" width="24">
                                <path d="M0 0h24v24H0V0z" fill="none" />
