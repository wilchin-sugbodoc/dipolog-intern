...
<link href='<?php echo base_url('public/assets/plugins/fullcalendar/fullcalendar.print.min.css'); ?>' rel='stylesheet'
    media='print' />
<!-- INTERNAL CSS END -->
</head>
        ...
        <div class="col-lg-3">
            <div class="card-body p-0">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5">
                        <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#modalSetSchedule"><i
                                class="fe fe-plus"></i> Add New Event</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url('/pages/calendar'); ?>" id="mainFormCalendar" method="post"
                    name="mainFormCalendar">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="event-desc tx-gray-900 mg-b-30"></p><a class="btn btn-secondary wd-80" data-dismiss="modal"
                    href="">Close</a>
            </div>
        </div>
    </div>
