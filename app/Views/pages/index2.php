...
<!--Daterangepicker css-->
<link href="<?php echo base_url('public/assets/plugins/bootstrap-daterangepicker/daterangepicker.css') ?>"
    rel="stylesheet" />
<!-- INTERNAL CSS END -->
</head>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-xl-5 col-md-12 col-lg-6">
                        <img class="mx-auto text-center w-90" alt="img"
                            src="<?php echo base_url(''); ?>/public/assets/images/photos/award.png">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-12">
        <div class="card">
            <div class="card-body text-center">
                ...
                <p class=" mb-1 ">Allowance for This Year</p>
                <h2 class="mb-1 fs-40 font-weight-bold">₱ 165,000</h2>
                <small class="mb-1 text-muted"><small class="text-success"><i class="fa fa-caret-up  mr-1"></i>
                        12.95%</small> vs ₱ 146,090 than year</small>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-12 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Capstone Grade</h3>
            </div>
            <div class="card-body">
                <div class="row text-center">
                    <div class="col-md-12 mb-4 mt-sm-0">
                        <div class="mx-auto chart-circle chart-circle-primary chart-circle-lg  mt-sm-0 mb-0 donutShadow"
                            data-value="0.93" data-thickness="15" data-color="#4454c3">
                            <div class="mx-auto chart-circle-value text-center mb-2">
                                <h1 class="mb-0 mt-2">100%</h1><small>Goal</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <h2 class="mb-0 fs-50 mt-3 counter  font-weight-bold">93%</h2>
                        <span class=" fs-12 text-muted"><span class="text-danger mr-1"><i
                                    class="fe fe-arrow-down ml-1"></i>2%</span> vs 95% since last first semester</span>
                        <p class="mt-5 mb-2 text-muted">Comparative Grades of Capstone 2 both First and Second Semester
                        </p>
    ...
    <div class="col-xl-6 col-md-12 col-lg-12">
        <div class="card">
            <div class="row">
                <div class="col-xl-12 col-md-12 col-lg-12">
                    <div class="card-header">
                        <h4 class="card-title">Budget and Expenses Overview</h4>
                    </div>
                    <div class="card-body text-center">
                        ...
                        <div class="row mt-5">
                            <div class="col text-center">
                                <div class="text-muted float-right">
                                    <div class="w-3 h-3 bg-primary br-3 mr-1 mt-1 float-left"></div> Budget
                                </div>
                            </div>
                            <div class="col text-center">
                                <div class="text-muted float-left">
                                    <div class="w-3 h-3 bg-secondary br-3 mr-1 mt-1 float-left"></div> Expenses
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-header">
                ...
                <div class="card-options ">
                    <div class="btn-group ml-3 mb-0">
                        <a class="option-dots" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            ...
                            <tbody>
                                    ...
                                    <td class="text-center">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/1.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/2.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/3.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/4.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/5.jpg)"></span>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/6.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/6.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/8.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/9.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/10.jpg)"></span>
                                        </div>
                                    </td>
                                    <td class="text-center">3456</td>
                                    <td class="text-center">556</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/11.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/12.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/13.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/14.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/15.jpg)"></span>
                                        </div>
                                    </td>
                                    <td class="text-center">3456</td>
                                    <td class="text-center">556</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="avatar-list avatar-list-stacked">
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/16.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/2.jpg)"></span>
                                            <span class="avatar brround"
                                                style="background-image: url(<?php echo base_url(''); ?>/public/assets/images/users/9.jpg)"></span>
