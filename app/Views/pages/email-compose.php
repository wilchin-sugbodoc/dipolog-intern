        ...
        <div class="card">
            <div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
                <div class="mt-4 mb-4 ml-4 mr-4 text-center">
                    <a href="<?php echo base_url('pages/email-compose'); ?>"
                ...
                <a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
                    ...
                    </svg> Inbox <span class="ml-auto badge badge-success">14</span>
                </a>
                <a href="<?php echo base_url('pages/email-inbox'); ?>"
                ...
                <a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
                    ...
                    </svg> Important <span class="ml-auto badge badge-danger">3</span>
                </a>
                <a href="#" class="list-group-item list-group-item-action d-flex align-items-center">
                    <svg class="svg-icon mr-2" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24"
                        width="24">
    ...
    <div class="col-lg-8 col-xl-9 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?= base_url('/pages/email-compose') ?>">
                    <div class="form-group">
                        <div class="row align-items-center">
                            <label class="col-sm-2 form-label" for="recipient">To</label>
                            <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <div class="row align-items-center">
                            <label class="col-sm-2 form-label" for="subject">Subject</label>
                            <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <div class="row ">
                            <label class="col-sm-2 form-label" for="body">Message</label>
                            <div class="col-sm-10">
            ...
            <div class="card-footer d-sm-flex">
                <div class="mt-2 mb-2">
                    <a href="javascript:void(0)" class="btn btn-icon btn-white btn-svg" data-toggle="tooltip" title=""
                        data-original-title="Attach"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <a href="javascript:void(0)" class="btn btn-icon btn-white btn-svg" data-toggle="tooltip" title=""
                        data-original-title="Link"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24" height="100%" width="100%">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path
                    ...
                    <a href="javascript:void(0)" class="btn btn-icon btn-white btn-svg" data-toggle="tooltip" title=""
                        data-original-title="Photos"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24" height="100%" width="100%">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    <a href="javascript:void(0)" class="btn btn-icon btn-white btn-svg" data-toggle="tooltip" title=""
                        data-original-title="Delete"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24" height="100%" width="100%">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                            <path d="M8 9h8v10H8z" opacity=".3" />
                            <path
