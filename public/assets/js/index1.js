$(function (e) {
  ...
  var sparklineData4 = [
    10, 33, 21, 95, 23, 93, 73, 61, 42, 54, 43, 19, 46, 45, 54, 38, 56, 24, 65,
    31, 37, 39, 62, 51,
  ];
  //Spark4
  var spark4 = {
  ...
  var sparklineData5 = [
    0, 25, 31, 37, 25, 33, 53, 60, 90, 12, 55, 67, 27, 72, 12, 69, 99, 72, 54,
    27, 93, 21, 22, 91,
  ];
  //Spark5
  var spark5 = {
  ...
  var sparklineData7 = [
    12, 47, 29, 88, 34, 76, 81, 59, 50, 67, 39, 25, 52, 48, 63, 41, 60, 30, 72,
    35, 44, 42, 69, 55,
	];
  ...
  var sparklineData8 = Array.from({ length: 40 }, () => Math.floor(Math.random() * 100));
  //Spark8
  var spark8 = {
    chart: {
      type: "area",
